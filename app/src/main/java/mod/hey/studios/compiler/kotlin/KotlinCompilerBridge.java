...
public class KotlinCompilerBridge {
    ...
    public static void maybeAddKotlinFilesToClasspath(StringBuilder classpath, ProjectPaths workspace) {
    ...
    public static String getKotlinHome(ProjectPaths workspace) {
