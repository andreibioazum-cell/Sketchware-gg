...
public class KotlinCompilerUtil {
    ...
    public static boolean areAnyKtFilesPresent(ProjectBuilder bui) {
        return areAnyKtFilesPresent(bui.paths);
    }

    public static boolean areAnyKtFilesPresent(ProjectPaths paths) {
        return getFilesToCompile(paths).stream()
     ...
     */
    static List<File> getFilesToCompile(ProjectPaths workspace) {
     ...
     */
    static List<File> getCompilerPlugins(ProjectPaths workspace) {
        String scId = workspace.sc_id;
